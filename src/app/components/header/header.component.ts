      ...
      <div class="header__actions">
        ...
        <div class="lang-menu-container">
          <button 
            ...
            [title]="i18n.t('settings.interfaceLanguage')"
          >
            <app-icon name="languages" [size]="18" />
          </button>
          
          @if (showLangMenu) {
            <div class="user-dropdown lang-dropdown">
              @for (lang of i18n.availableLanguages; track lang.code) {
                <button 
                  class="dropdown-btn lang-item" 
        ...
        @if (auth.isLoggedIn()) {
          ...
          <button class="google-btn" (click)="signIn()" [title]="i18n.t('settings.signInGoogle')">
        ...
        <button 
          class="btn btn-icon btn-ghost theme-btn"
          (click)="toggleTheme()"
          [attr.aria-label]="i18n.t('header.toggleTheme')"
...
export class HeaderComponent {
  ...
  onClickOutside(event: MouseEvent) {
    ...
    // Close lang menu
    if (this.showLangMenu && !target.closest('.lang-menu-container')) {
      this.showLangMenu = false;
    }
  }
}
