      ...
      <div class="settings-sheet">
        ...
        <div class="settings-section">
          @if (auth.isLoggedIn()) {
            ...
            <button class="google-signin-card" (click)="signIn()">
              ...
              <div class="google-signin-content">
                <span class="google-signin-title">{{ i18n.t('settings.signInGoogle') }}</span>
                <span class="google-signin-hint">{{ i18n.t('settings.syncVocab') }}</span>
              </div>
              <app-icon name="chevron-right" [size]="18" class="google-signin-arrow" />
            </button>
          }
        </div>
