...
export const GRAMMAR_JA_JA: Record<string, GrammarTranslation> = {
  "ja_n5_A_0": {
    ...
    "shortExplanation": "ある範囲の中で最も程度が高いこと（最上級）を表し、「一番〜」「もっとも〜」という意味を表します。",
    "longExplanation": "「A が いちばん～」は、ある特定の範囲や集団の中で、Aが最もその性質や状態、動作の度合いが高いこと（最上級）を表す文法表現です。様々な形容詞や動詞とともに用いられ、他のものと比較して最高位であることを示します。",
    "formation": "名詞 + が + いちばん (一番) + 形容詞/動詞",
    "examples": [
      {
        "translation": "この中で、寿司が一番好きです。"
      },
      {
        "translation": "彼女はクラスで一番速く泳げます。"
      },
      {
        "translation": "この町では、この公園が一番きれいです。"
      },
      {
        "translation": "飲み物の中では、紅茶が一番好きです。"
      }
    ]
  },
  "ja_n5_AけれどもB_1": {
  ...
  "ja_n5_A_6": {
    ...
    "shortExplanation": "ある範囲や基準、話題を限定して比較や評価を述べる表現で、「〜においては」「〜の中では」という意味を表します。",
    "longExplanation": "「A では、～B」は、名詞Aを比較の基準や枠組み、特定の分野・範囲として提示し、その中における特徴、評価、最上級の事実などを文Bで述べる文法表現です。「〜の中では」「〜の点では」という意味合いを表します。",
    "formation": "名詞A + では、 + 主語 + 述語B",
    "examples": [
      {
        "translation": "果物では、リンゴが一番好きです。"
      },
      {
        "translation": "スポーツでは、サッカーが一番人気です。"
      },
      {
        "translation": "今日の天気では、雨が降りそうです。"
      },
      {
        "translation": "料理では、和食が一番得意です。"
      }
    ]
  },
  "ja_n5_AでもB_7": {
  ...
  "ja_n5_A_10": {
    ...
    "shortExplanation": "主題Aを提示し、その部分や性質・能力・特徴であるBを説明・描写する構文で、「AはBが〜だ」という意味を表します。",
    "longExplanation": "「A は B が〜」は、文全体の主題（大主語）を「Aは」で提示し、その対象の身体の一部分や属性、能力、嗜好などの具体的な特徴（小主語）を「Bが」で示して形容詞や動詞で描写する日本語の基本構文です（有題文・いわゆる象の鼻構文）。",
    "formation": "A は (主題) + B が (部分/属性/対象) + 形容詞/動詞",
    "examples": [
      {
        "translation": "彼女は髪が長いです。"
      },
      {
        "translation": "このレストランは雰囲気が良いです。"
      },
      {
        "translation": "私は朝ごはんが一番好きです。"
      },
      {
        "translation": "彼は英語が得意です。"
      }
    ]
  },
  "ja_n5_A_11": {
    "title": "A は B より～ (A wa B yori～)",
    "shortExplanation": "2つの事物を比較し、AがBよりも程度が高いことを表す表現で、「AはBより〜だ」という意味を表します。",
    "longExplanation": "「A は B より～」は、二つの事物AとBを比較する際の基本的な文型です。比較の基準となる対象Bに助詞「より」を付け、主語であるAの方がBよりもその性質や状態の度合いが上であることを表します。",
    "formation": "A は + B より + 形容詞/動詞",
    "examples": [
      {
        "translation": "このジュースはあのジュースより甘いです。"
      },
      {
        "translation": "夏は冬より暑いです。"
      },
      {
        "translation": "彼女は私より速く走ります。"
      },
      {
        "translation": "スーパーはコンビニより安いです。"
      }
    ]
  },
  "ja_n5_A_12": {
  ...
  "ja_n5_Noun_21": {
    "title": "名詞1 ＋ か ＋ 名詞2（か）（選択の並立）",
    "shortExplanation": "複数の選択肢を並べて、どちらか一方を選ぶことを表します。「〜か〜」「あるいは」。",
    "longExplanation": "並立助詞「か」を名詞や節の間に置くことで、複数の選択肢や代替案を提示する文法表現です。「AかB」の形で「AまたはB」を表すほか、「AかBか」と重ねて選択や迷いの対象であることを強調することもあります。",
    "formation": "名詞1 + か + 名詞2 (+ か)",
    "examples": [
      {
        "translation": "今日、映画を見るか、散歩するかどちらにしますか？"
      },
      {
        "translation": "コーヒーか紅茶か、一つだけ選んでください。"
      },
      {
        "translation": "電車かバスを使って、学校に行くつもりです。"
      },
      {
        "translation": "週末は山に登るか海に行くか、まだ決めていません。"
      }
    ]
  },
  "ja_n5_Noun_22": {
    "title": "名詞 ＋ が できます（能力・可能）",
    "shortExplanation": "ある事柄を行う能力や技能があることを表します。「〜ができる」「〜が得意だ」。",
    "longExplanation": "「名詞 ＋ が できます」は、主体がその事柄・活動を行う能力や技能を有していることを表す基本的な可能表現です。名詞には、言語（英語など）、スポーツ・運動（泳ぎなど）、楽器（ピアノなど）、動作性名詞（料理など）が入り、それらを行うことができる能力を示します。",
    "formation": "名詞 + が + できます",
    "examples": [
      {
        "translation": "英語ができます。"
      ...
      {
        "translation": "彼は泳ぎができます。"
      },
      {
        "translation": "彼女はピアノができます。"
      }
    ]
  },
  "ja_n5_Noun_23": {
    "title": "名詞 ＋ が ほしいです（願望・欲しいもの）",
    "shortExplanation": "ある物や対象を手に入れたい、所有したいという願望を丁寧に表します。「〜がほしい」。",
    "longExplanation": "「名詞 ＋ が ほしいです」は、主体がその物や対象を欲していることを表す表現です。動作を行いたい願望を表す「〜たい」とは異なり、名詞（手に入れたい物や人間関係など）を助詞「が」で提示します。基本的に話し手（一人称）の願望を表し、三人称の願望を表す場合は通常「〜をほしがっています」を用います。",
    "formation": "名詞 + が + ほしいです",
    "examples": [
      {
        "translation": "新しい車がほしいです。"
      },
      {
        "translation": "コーヒーがほしいです。"
      },
      {
        "translation": "彼女は花がほしいです。"
      },
      {
        "translation": "友達がほしいです。"
      }
    ]
  },
  "ja_n5_Noun_24": {
    "title": "名詞1 ＋ から ＋ 名詞2 ＋ まで（起点と終点・範囲）",
    "shortExplanation": "時間や場所、数量の範囲の始まり（起点）と終わり（終点・限界）を表します。「〜から〜まで」。",
    "longExplanation": "「～から ～まで」は、時間・空間・数量などの起点（から）と終点（まで）を対にして表す基本的な文法表現です。「〜から」で出発点や開始時刻を示し、「〜まで」で到着点や終了時刻を示します。一連の行為や状態が継続する範囲を明示します。",
    "formation": "名詞1（起点） + から + 名詞2（終点） + まで",
    "examples": [
      {
        "translation": "朝9時から午後5時まで働きます。"
      },
      {
        "translation": "東京から大阪まで電車で行く。"
      },
      {
        "translation": "地下鉄は午前6時から深夜まで運行しています。"
      },
      {
        "translation": "月曜日から金曜日まで学校に通います。"
      }
    ]
  },
  "ja_n5_Noun_25": {
    "title": "名詞 ＋ くらい（概数・程度）",
    "shortExplanation": "数量や時間、程度の目安や大体の数値を表します。「約〜」「〜ほど」。",
    "longExplanation": "副助詞「くらい」は、数量詞や名詞の後ろに付き、大体の数量・時間・程度を見積もって表す表現です。「約〜」「〜ほど」という意味合いになります。現代日本語において濁音の「ぐらい」と意味的な差はほとんどなく、多くの場合互換的に用いられます。",
    "formation": "名詞 / 数量詞 + くらい",
    "examples": [
      {
        "translation": "この本は三百ページくらいあります。"
      },
      {
        "translation": "彼の家まで歩いて20分くらいかかります。"
      },
      {
        "translation": "明日は暑くて、30度くらいになるでしょう。"
      },
      {
        "translation": "この料理を作るのに、材料は500円くらい必要です。"
      }
    ]
  },
  "ja_n5_Noun_26": {
    "title": "名詞 ＋ ぐらい（概数・数量の目安）",
    "shortExplanation": "数量や時間、程度の見当を表す濁音化された形式です。「約〜」「〜ほど」「〜くらい」。",
    "longExplanation": "副助詞「ぐらい」（「くらい」の連濁形）は、数量詞や時間詞、名詞の後に接続し、大体の数量や時間、度合いを見積もる表現です。「約〜」「〜程度」という意味を表し、日常の会話や文章で極めて広く用いられます。",
    "formation": "名詞 / 数量詞 + ぐらい",
    "examples": [
      {
        "translation": "一日中勉強したので、１０時間ぐらい勉強しました。"
      },
      {
        "translation": "この本は１００ページぐらいある。"
      },
      {
        "translation": "彼は果物を５個ぐらい食べました。"
      },
      {
        "translation": "駅から家まで歩いて２０分ぐらいかかります。"
      }
    ]
  },
  "ja_n5_Noun_27": {
    "title": "時間名詞 ＋ ごろ（おおよその時点・時期）",
    "shortExplanation": "特定の時刻や時期、年齢の後ろに付き、おおよその時点を表します。「〜頃」「〜あたり」。",
    "longExplanation": "接尾辞「ごろ」は、時刻や季節、年代など特定の「時点」を表す名詞に接続し、その前後のおおよその時間帯を示します。期間や時間の長さを表す「くらい／ぐらい」（例：3時間くらい）とは異なり、ピンポイントの時刻・時期の目安（例：3時ごろ）を指す際に用いられます。",
    "formation": "時点を表す名詞 / 年齢 + ごろ (+ に)",
    "examples": [
      {
        "translation": "昼ごろに電話してください。"
      },
      {
        "translation": "彼は10歳ごろに日本に来ました。"
      },
      {
        "translation": "午後３時ごろに会いましょう。"
      },
      {
        "translation": "昨日の夜8時ごろに帰りました。"
      }
    ]
  },
  "ja_n5_Noun_28": {
    "title": "名詞 / 動詞 ＋ だけ（限定）",
    "shortExplanation": "範囲や数量を限定し、それ以外を排除することを表します。「〜のみ」「〜だけ」。",
    "longExplanation": "副助詞「だけ」は、名詞や動詞の普通形、形容詞などに接続して、その事柄や数量に限る（限定する）ことを表す文法表現です。他を排してそれだけであることを示し、「〜のみ」に相当します。日常会話から文章語まで幅広く使われ、「〜だけでなく（〜のみならず）」の形でも頻出します。",
    "formation": "名詞 + だけ / 動詞普通形 + だけ / い形容詞 + だけ / な形容詞 + な + だけ",
    "examples": [
      {
        "translation": "コーヒーだけ飲んで、帰りました。"
      },
      {
        "translation": "この本は二十ページだけ読んだ。"
      },
      {
        "translation": "彼女はとても速いですが、走るだけでなく、考えるのも速いです。"
      },
      {
        "translation": "この部屋は寝るだけの場所です。"
      }
    ]
  },
  "ja_n5_Nounで_29": {
  ...
  "ja_n5_Noun_30": {
    "title": "名詞 ＋ と～",
    "shortExplanation": "名詞と名詞を並列して「〜と」と完全に列挙したり、動作を共にする相手を表して「〜と一緒に」という意味を表します。",
    "longExplanation": "格助詞「と」は、名詞に接続して主に2つの用法を持ちます。1つは事物をすべて漏れなく並列・列挙する用法（全部列挙）で、「AとB」のように使われます。もう1つは動作を共に行う相手や同伴者を表す用法で、「（人と）一緒に」という意味を表し、副詞「一緒に」を伴って使われることも多いです。",
    "formation": "名詞1 ＋ と ＋ 名詞2 ／ 名詞（人・相手） ＋ と（一緒に）",
    "examples": [
      {
        "translation": "リンゴとバナナを買いました。"
      },
      {
        "translation": "友達と映画を見に行きます。"
      },
      {
        "translation": "父と母と一緒に旅行しました。"
      },
      {
        "translation": "彼と彼女は結婚しました。"
      }
    ]
  },
  "ja_n5_Noun_31": {
    "title": "名詞 ＋ に～",
    "shortExplanation": "移動の帰着点・目的地、動作が行われる特定の時間、動作の相手・対象などを表します。",
    "longExplanation": "格助詞「に」は名詞に接続し、多様な意味役割を示します。主な用法として、①動作が行われる特定の時（数字を伴う時間など）、②移動動詞に伴う目的地・帰着点（「日本に行く」など）、③動作や働きかけの相手・受け手（「彼女にあげる」「友達に書く」など）を表します。",
    "formation": "名詞（時・場所・相手など） ＋ に",
    "examples": [
      {
        "translation": "彼女にプレゼントをあげました。"
      },
      {
        "translation": "日本に行きます。"
      },
      {
        "translation": "6時に集合しましょう。"
      },
      {
        "translation": "友達に手紙を書きます。"
      }
    ]
  },
  "ja_n5_Noun_32": {
    "title": "名詞 ＋ に帰ります",
    "shortExplanation": "自分が本来所属している場所や生活の拠点へ戻ることを表し、「〜に帰る・戻る」という意味です。",
    "longExplanation": "「名詞 ＋ に帰ります」は、自宅（家）、実家、自国（国）、学校など、話し手が本来所属している場所や生活の拠点へと戻る動作を表します。格助詞「に」は帰着点（戻る目的地）を示します。",
    "formation": "名詞（場所・生活拠点） ＋ に ＋ 帰ります",
    "examples": [
      {
        "translation": "夏休みが終わったら、学校に帰ります。"
      },
      {
        "translation": "買い物を終えたら、家に帰ります。"
      },
      {
        "translation": "今週末、実家に帰ります。"
      },
      {
        "translation": "友達と旅行に行ったあと、東京に帰ります。"
      }
    ]
  },
  "ja_n5_Noun_33": {
    "title": "名詞 ＋ にします",
    "shortExplanation": "複数の選択肢の中から自分の意思で1つを選んで決めることを表し、「〜にする・〜に決める」という意味です。",
    "longExplanation": "「名詞 ＋ にします」は、レストランでの注文、買い物での商品選び、予定の決定など、いくつかの候補や可能性の中から話し手が主観的に選択・決定した結果を表す表現です。動詞句を受ける場合は「〜ことにします」の形になります。",
    "formation": "名詞 ＋ に します",
    "examples": [
      {
        "translation": "今日の昼ご飯は寿司にします。"
      },
      {
        "translation": "この靴を買うか迷っていますが、赤い色の方にします。"
      },
      {
        "translation": "休みの日に何をするか決めた。映画館に行くことにします。"
      },
      {
        "translation": "フランス語とスペイン語のどちらを勉強するか悩んだが、フランス語にします。"
      }
    ]
  },
  "ja_n5_Noun_34": {
    "title": "名詞 ＋ になります",
    "shortExplanation": "状態や性質、身分などが変化して別の状態になることを表し、「〜になる」という意味です。",
    "longExplanation": "「名詞 ＋ になります」は、物事が自然な推移や時間の経過、客観的な変化を経てある身分・職業・状態・時期へと移行・到達することを表します。主観的な選択を表す「〜にします」とは対照的に、自然な変化や客観的な結果を表す際に用いられます。",
    "formation": "名詞 ＋ に ＋ なります",
    "examples": [
      {
        "translation": "彼は医者になります。"
      },
      {
        "translation": "この茶色の葉が赤になります。"
      },
      {
        "translation": "料理が冷めたら、美味しくなくなります。"
      },
      {
        "translation": "来年、東京オリンピックになります。"
      }
    ]
  },
  "ja_n5_Noun_35": {
    "title": "名詞 ＋ に来ます",
    "shortExplanation": "話し手のいる場所や基準となる場所へ向かって移動してくることを表し、「〜に来る」という意味です。",
    "longExplanation": "「名詞 ＋ に来ます」は、人や物が話し手の現在地や話題の視点がある場所へと向かって移動する動作を表します。「に」の前の名詞は到着地・目的地を示します。",
    "formation": "名詞（場所） ＋ に ＋ 来ます",
    "examples": [
      {
        "translation": "友達が私の家に来ます。"
      },
      {
        "translation": "今晩、父が駅に迎えに来ます。"
      },
      {
        "translation": "明日、先生が学校に来ます。"
      },
      {
        "translation": "有名な歌手がこの街に来ます。"
      }
    ]
  },
  "ja_n5_Noun_36": {
    "title": "名詞 ＋ に行きます",
    "shortExplanation": "話し手がある場所から別の目的地へと向かって移動することを表し、「〜へ・に行く」という意味です。",
    "longExplanation": "「名詞 ＋ に行きます」は、話し手が現在いる場所を離れて、別の目的地や場所へと向かって移動する動作を表します。格助詞「に」は移動の目的地・到達点を示します。",
    "formation": "名詞（場所） ＋ に ＋ 行きます",
    "examples": [
      {
        "translation": "学校に行きます。"
      },
      {
        "translation": "明日、スーパーに行きます。"
      },
      {
        "translation": "週末に映画館に行きます。"
      },
      {
        "translation": "夏休みに海に行きます。"
      }
    ]
  },
  "ja_n5_Noun_37": {
    "title": "名詞 ＋ のあとで",
    "shortExplanation": "ある出来事や動作の終了後に別の動作や事態が起きる時間的順序を表し、「〜の後に」という意味です。",
    "longExplanation": "「名詞 ＋ のあとで」は、名詞が表す出来事や行動（食事・会議・映画など）が終わった後のタイミングで、次の動作や出来事が行われることを表します。名詞と「あとで」は連体助詞「の」で接続します。",
    "formation": "名詞（出来事・動作） ＋ の ＋ あとで",
    "examples": [
      {
        "translation": "朝ご飯のあとで、歯を磨きます。"
      },
      {
        "translation": "映画のあとで、レストランで夕食を食べました。"
      },
      {
        "translation": "会議のあとで、上司と話し合います。"
      },
      {
        "translation": "晩ご飯のあとで、散歩に行きました。"
      }
    ]
  },
  "ja_n5_Noun_38": {
    "title": "名詞 ＋ の前に",
    "shortExplanation": "ある場所や人、建物の空間的な位置関係として「〜の正面・手前」を表し、「〜の前に」という意味です。",
    "longExplanation": "「名詞 ＋ の前に」は、基準となる人物や建物・場所のすぐ手前や正面という空間的位置を表します。名詞と位置名詞「前」を連体助詞「の」で接続し、「に」で存在場所や動作の到達点を示します。",
    "formation": "名詞（場所・人・建物） ＋ の ＋ 前に",
    "examples": [
      {
        "translation": "駅の前にコンビニがあります。"
      },
      {
        "translation": "家の前に車を止めてください。"
      },
      {
        "translation": "私の前に彼が立っていました。"
      },
      {
        "translation": "ホテルの前にタクシーが来た。"
      }
    ]
  },
  "ja_n5_Noun_39": {
    "title": "名詞 ＋ は～",
    "shortExplanation": "文の主題（話題のテーマ）を提示する取り立て助詞で、「〜について言えば」という意味を表します。",
    "longExplanation": "係助詞（取り立て助詞）「は」（発音は「ワ」）は、名詞に付いてその文が「何について述べるのか」という話題の主題を提示します。文の焦点は「は」の後ろの述語部分に置かれます。主語そのものを特定・指定する格助詞「が」とは役割が異なります。",
    "formation": "名詞 ＋ は",
    "examples": [
      {
        "translation": "私は日本の料理が好きです。"
      },
      {
        "translation": "彼は英語が上手です。"
      },
      {
        "translation": "この本は面白いです。"
      },
      {
        "translation": "今日は暑いですね。"
      }
    ]
  },
  "ja_n5_Noun_40": {
    "title": "名詞 ＋ も～",
    "shortExplanation": "既に出た事柄と同類・同様であることを表し、「〜も（同様に）」という意味を表します。",
    "longExplanation": "係助詞「も」は、名詞に接続して、前に述べられたことと同じ事態・性質がこの名詞にも当てはまること（同類の追加・添加）を表します。通常「は」や「が」の代わりに用いられます。また「名詞1＋も＋名詞2＋も」と重ねて使うことで、「AもBも両方」という並列・網羅を表します。",
    "formation": "名詞 ＋ も ／ 名詞1 ＋ も ＋ 名詞2 ＋ も",
    "examples": [
      {
        "translation": "私も日本語を勉強しています。"
      },
      {
        "translation": "彼もケーキが好きです。"
      },
      {
        "translation": "東京も大阪も観光スポットがたくさんあります。"
      },
      {
        "translation": "この映画もあの映画も面白かった。"
      }
    ]
  },
  "ja_n5_Noun_41": {
    "title": "名詞1 ＋ や ＋ 名詞2 ＋ など～",
    "shortExplanation": "同類のものの中から代表的な例をいくつか挙げる不完全列挙を表し、「〜や〜など」という意味です。",
    "longExplanation": "「名詞1 ＋ や ＋ 名詞2 ＋ など」は、同類の事物の中から代表的なものを2〜3点例示し、他にも同類の事柄があることを暗示する不完全列挙（一部列挙）の表現です。すべてを挙げ尽くす「と」（完全列挙）と使い分けられます。",
    "formation": "名詞1 ＋ や ＋ 名詞2（＋ など）",
    "examples": [
      {
        "translation": "彼は野菜や果物などを食べるのが好きです。"
      },
      {
        "translation": "日本の都市や東京、大阪などに行きたいです。"
      },
      {
        "translation": "彼女は猫や犬など動物が好きです。"
      },
      {
        "translation": "この本屋では漫画や小説などたくさんの本が売られています。"
      }
    ]
  },
  "ja_n5_Noun_42": {
    "title": "名詞 ＋ を～",
    "shortExplanation": "他動詞が表す動作や働きかけの直接の対象（目的語）を表します。",
    "longExplanation": "格助詞「を」（発音は「オ」）は、名詞に接続して、その名詞が他動詞の表す動作や働きかけを受ける直接の対象（目的語）であることを示します。「本を読む」「ご飯を食べる」のように動作が向けられる事物を導きます。",
    "formation": "名詞（目的語） ＋ を ＋ 他動詞",
    "examples": [
      {
        "translation": "私は本を読みます。"
      },
      {
        "translation": "彼はケーキを食べました。"
      },
      {
        "translation": "母はコーヒーを飲むのが好きです。"
      },
      {
        "translation": "友達が私のペンを使いました。"
      }
    ]
  },
  "ja_n5_Verb_43": {
    "title": "動詞た形 ＋ あとで",
    "shortExplanation": "前項の動作が完了した後に、次の動作を行うことを表し、「〜した後に」「〜してから」という意味です。",
    "longExplanation": "「動詞た形 ＋ あとで」は、2つの動作の時間的な前後関係を表す文型です。前項の動詞を過去・完了を表す「た形」にすることで、前項の行為が完全に終了したことを確認してから後項の行為を行うという順序を示します。",
    "formation": "動詞 た形 ＋ あとで",
    "examples": [
      {
        "translation": "宿題をしたあとで、テレビを見ました。"
      },
      {
        "translation": "朝ごはんを食べたあとで、歯を磨きます。"
      },
      {
        "translation": "仕事が終わったあとで、ジムに行く予定です。"
      },
      {
        "translation": "映画を見たあとで、カフェでコーヒーを飲みました。"
      }
    ]
  },
  "ja_n5_Verb_44": {
    "title": "動詞連用形（ます形語幹） ＋ たいです",
    "shortExplanation": "話し手がある行為を行いたいという希望や願望を表し、「〜したい」「〜したいです」という意味を表します。",
    "longExplanation": "希望の助動詞「たい」は動詞の連用形（ます形の「ます」を取った形）に接続し、主に話し手（第1人称）が特定の行為をしたいという願望・意志を表します。丁寧に述べる場合は「です」を付けて「〜たいです」とします。対象を示す格助詞「を」は「が」になることもあります（例：「水を飲みたい／水が飲みたい」）。三人称の願望を述べる際は、通常「〜たがっている」「〜たいと言っている」などの形式を用います。",
    "formation": "動詞連用形（ます形語幹） ＋ たいです（1グループ動詞：語尾のう段をい段に変える＋たいです、2グループ動詞：るを取る＋たいです、3グループ動詞：する→したいです、くる→きたいです）",
    "examples": [
      {
        "translation": "私は寿司を食べたいです。"
      },
      {
        "translation": "彼は日本に行きたいです。"
      },
      {
        "translation": "彼女は英語を勉強したいです。"
      },
      {
        "translation": "子供たちは遊びたいです。"
      }
    ]
  },
  "ja_n5_Verb_45": {
    "title": "～て (～te)",
    "shortExplanation": "動作や状態を時間的な順序でつなぎ、「〜して、〜する」「〜してから」という意味を表します。",
    "longExplanation": "動詞の「て形」は、日本語の文法において最も基本的かつ重要な活用形の一つであり、複数の動作や出来事、状態を時間の流れに沿って順番に接続する際に用いられます（前の動作が完了した後に次の動作を行うことを表します）。さらに、依頼を表す「～てください」や進行・状態を表す「～ています」など、多種多様な補助動詞と結合して豊かな文末表現を作る基礎となります。文全体の時制は文末の動詞によって決まります。",
    "formation": "1グループ（五段動詞）：語尾に応じて音便変化（く→いて、ぐ→いで、す→して、む/ぶ/ぬ→んで、つ/る/う→って、例外：行く→行って） | 2グループ（一段動詞）：るを取る + て | 3グループ（不規則動詞）：する→して、くる→きて",
    "examples": [
      {
        "translation": "コーヒーを飲んで、出かけます。"
      },
      {
        "translation": "買い物をして、家に帰りましょう。"
      },
      {
        "translation": "宿題をして、寝ます。"
      },
      {
        "translation": "友達を待って、一緒に映画を見に行きます。"
      }
    ]
  },
  "ja_n5_Verb_46": {
    "title": "～て います (～te imasu)",
    "shortExplanation": "現在進行中の動作や、動作の結果生じた状態の継続を表し、「〜している」「〜しているところだ」という意味を表します。",
    "longExplanation": "「～ています」は、動詞のて形に補助動詞「います」が接続し、発話の時点において動作が進行中であることを表す文型です（継続動詞の場合）。また、結果が残る瞬間動詞や状態変化動詞（結婚する、住む、知るなど）に接続した場合には、動作が完了した結果の状態が現在もそのまま続いていることを表します。丁寧体は「～ています」、普通体は「～ている」となります。",
    "formation": "動詞 て形 + います",
    "examples": [
      {
        "translation": "彼女は今ピアノを弾いています。"
      },
      {
        "translation": "私たちは日本語を勉強しています。"
      },
      {
        "translation": "彼は映画を見ています。"
      },
      {
        "translation": "入っていますので、お待ちください。"
      }
    ]
  },
  "ja_n5_Verb_47": {
    "title": "～てから (～te kara)",
    "shortExplanation": "ある動作を完了した後に次の動作を行うことを表し、「〜したあとで」「〜してから」という意味を表します。",
    "longExplanation": "「～てから」は、動詞のて形に接続助詞「から」が接続した表現で、前項の動作が完全に終わったことを受けて、次の後項の動作に移るという前後の時間的順序関係を明示・強調します。単純に「て」でつなぐ場合と比べて、前項が後項の開始条件や契機であることを際立たせるニュアンスがあります。文全体の時制は文末の動詞によって決定されます。",
    "formation": "動詞 て形 + から",
    "examples": [
      {
        "translation": "宿題をしてから、テレビを見ました。"
      },
      {
        "translation": "食べてから、歯を磨きましょう。"
      },
      {
        "translation": "仕事が終わってから、友達と飲みに行きます。"
      },
      {
        "translation": "学校が終わってから、図書館で勉強します。"
      }
    ]
  },
  "ja_n5_Verb_48": {
    "title": "～てください (～te kudasai)",
    "shortExplanation": "相手に対して丁寧に依頼・指示・お願いをする表現で、「〜してください」という意味を表します。",
    "longExplanation": "「～てください」は、相手に何らかの行為を行うよう丁寧にお願いしたり指示したりする際に最も一般的に使われる表現です。動詞のて形に補助動詞「ください」を接続します。日常会話において広く用いられる丁寧な依頼表現ですが、相手に動作を促す性質を持つため、ビジネスシーンや目上の人に対して改まったお願いをする際は、より敬意の高い表現（「～ていただけますか」「～ていただけませんか」など）を用いるのが適切とされます。",
    "formation": "動詞 て形 + ください",
    "examples": [
      {
        "translation": "ドアを開けてください。"
      },
      {
        "translation": "電話番号を教えてください。"
      },
      {
        "translation": "ゆっくり話してください。"
      },
      {
        "translation": "コーヒーを一つ持ってきてください。"
      }
    ]
  },
  "ja_n5_Verb_49": {
    "title": "～ないでください (～naide kudasai)",
    "shortExplanation": "相手にある行為をしないように丁寧にお願い・制止する表現で、「〜しないでください」という意味を表します。",
    "longExplanation": "「～ないでください」は、相手にある動作や行為を行わないように丁寧に依頼したり、注意・制止したりする際に用いる文型です。動詞のない形に助詞「で」と「ください」を接続して作ります。公共の場所における注意事項やマナーの呼びかけ、また日常生活の中で相手の行動を柔らかく制止したい場面で幅広く使われます。",
    "formation": "動詞 ない形 + で ください",
    "examples": [
      {
        "translation": "タバコを吸わないでください。"
      },
      {
        "translation": "ここで走らないでください。"
      },
      {
        "translation": "大きな声で話さないでください。"
      },
      {
        "translation": "写真を撮らないでください。"
      }
    ]
  },
  "ja_n5_Noun_50": {
    "title": "～に戻ります (～ni modorimasu)",
    "shortExplanation": "以前の状態、場所、仕事などに復帰・復元することを表し、「〜に戻る」「〜に復帰する」という意味を表します。",
    "longExplanation": "「名詞 ＋ に ＋ 戻ります」は、変化や中断を経た後に、以前あった本来の状態や位置、職場、活動などへ再び立ち返ることを表す文型です。動詞「戻る」は元の状態や場所への復帰・復元を意味し、格助詞「に」はその帰着点や結果となる状態を示します。日常会話からビジネスまで幅広く使われます。",
    "formation": "名詞 + に + 戻ります",
    "examples": [
      {
        "translation": "冷蔵庫に入れると、溶けたアイスクリームは固体に戻ります。"
      },
      {
        "translation": "休暇が終わったら、仕事に戻ります。"
      },
      {
        "translation": "リモートワークが終わった後、元のオフィスに戻ります。"
      },
      {
        "translation": "外国で勉強した後、日本に帰ります。"
      }
    ]
  },
  "ja_n5_Verb_51": {
    "title": "～に来ます (～ni kimasu)",
    "shortExplanation": "ある場所へ来る目的を表し、「〜しに来る」という意味を表します。",
    "longExplanation": "「動詞（ます形語幹） ＋ に ＋ 来ます」は、話し手がいる場所へ移動して来る目的を表す文法表現です。動作を表す動詞のます形から「ます」を除いた語幹に、目的を示す格助詞「に」を接続し、移動動詞「来ます」を続けます。場所を示す名詞と助詞「へ／に」を伴って用いることも多くあります（例：ここへ友達に会いに来ました）。",
    "formation": "動詞 ます形（「ます」を除く） + に + 来ます",
    "examples": [
      {
        "translation": "友達に会いに来ました。"
      },
      {
        "translation": "映画を見に来ました。"
      },
      {
        "translation": "先生に質問しに来ました。"
      },
      {
        "translation": "買い物をしに来ました。"
      }
    ]
  },
  "ja_n5_Verb_52": {
    "title": "～に行きます (～ni ikimasu)",
    "shortExplanation": "ある場所へ行く目的を表し、「〜しに行く」という意味を表します。",
    "longExplanation": "「動詞（ます形語幹） ＋ に ＋ 行きます」は、別の場所へ移動していく目的を表す文型です。動作動詞のます形から「ます」を除いた形に、目的を示す格助詞「に」を接続し、移動動詞「行きます」をつなげます。一般的に「場所 ＋ へ／に」を前に伴い、「〜へ〜しに行く」の形で多用されます。",
    "formation": "動詞 ます形（「ます」を除く） + に + 行きます",
    "examples": [
      {
        "translation": "公園に遊びに行きます。"
      },
      {
        "translation": "図書館に勉強しに行きます。"
      },
      {
        "translation": "スーパーに買い物に行きます。"
      },
      {
        "translation": "映画館に映画を見に行きます。"
      }
    ]
  },
  "ja_n5_Verb_53": {
    "title": "～ましょう (～mashou)",
    "shortExplanation": "相手に一緒にある行動をしようと丁寧に促したり誘ったりする表現で、「〜しましょう」という意味を表します。",
    "longExplanation": "「～ましょう」は、動詞のます形から「ます」を除いた語幹に接続し、聞き手を誘って一緒にある動作を行うことを丁寧に提案・勧誘する文法表現です。また、話し手自身が積極的に何かを行おうとする意志を表す場合にも用いられます。親近感と協調性を込めて「一緒に」などの副詞を伴うことがよくあります。",
    "formation": "動詞 ます形（「ます」を除く） + ましょう",
    "examples": [
      {
        "translation": "一緒に映画を見ましょう。"
      },
      {
        "translation": "散歩しましょう。"
      },
      {
        "translation": "今晩、食事に行きましょう。"
      },
      {
        "translation": "明日勉強しましょう。"
      }
    ]
  },
  "ja_n5_Verb_54": {
    "title": "～ましょうか (～mashou ka)",
    "shortExplanation": "相手の意向を伺いながら勧誘・提案したり、相手に手助けを申し出たりする表現で、「〜しましょうか」「（私が）〜しましょうか」という意味を表します。",
    "longExplanation": "「～ましょうか」には主に二つの使い方があります。①相手の意向を尋ねつつ「一緒に〜しませんか」と提案・勧誘する場合（例：「映画を見に行きましょうか」）。②相手のために話し手が手助けや援助を進んで申し出る場合（例：「荷物を持ちましょうか」）。動詞のます形語幹に「ましょうか」を接続します。相手への気配りを表す非常に親切な表現です。",
    "formation": "動詞 ます形（「ます」を除く） + ましょうか",
    "examples": [
      {
        "translation": "一緒に映画を見に行きましょうか。"
      },
      {
        "translation": "コーヒーをもう一杯飲みましょうか。"
      },
      {
        "translation": "あなたの荷物を持ちましょうか。"
      },
      {
        "translation": "窓を開けましょうか。"
      }
    ]
  },
  "ja_n5_Verb_55": {
    "title": "～ませんか (～masen ka)",
    "shortExplanation": "相手に丁寧かつ控えめに勧誘や誘いかけをする表現で、「〜しませんか」「〜しませんか（いかがですか）」という意味を表します。",
    "longExplanation": "「～ませんか」は、相手を何かの行為に誘う際に用いられる、非常に丁寧で配慮の行き届いた勧誘表現です。動詞の否定形（ます形語幹＋ません）に疑問の終助詞「か」を付けることで、相手に無理強いせず断る余地を残すため、相手への敬意や気遣いを示すことができます。「〜ましょう」よりも控えめで丁寧な響きを持ちます。",
    "formation": "動詞 ます形（「ます」を除く） + ませんか",
    "examples": [
      {
        "translation": "一緒に映画を見ませんか。"
      },
      {
        "translation": "明日のパーティーに参加しませんか。"
      },
      {
        "translation": "週末にピクニックに行きませんか。"
      },
      {
        "translation": "一緒に勉強しませんか。"
      }
    ]
  },
  "ja_n5_Verb_56": {
    "title": "～こと (～koto)",
    "shortExplanation": "動詞を名詞化し、動作や出来事を一つの事柄・概念として表す表現で、「〜すること」という意味を表します。",
    "longExplanation": "「～こと」は、動詞の辞書形（基本形）に形式名詞「こと」を後続させることで、その動作や事象を名詞化（名詞句化）する文法機能です。名詞化されることにより、文中で主語、目的語、補語などの位置に置くことが可能になり、助詞「が」「は」「を」などと自由に結びつくことができます。趣味や能力、一般的な事実や抽象的な概念を述べる際によく使われます。",
    "formation": "動詞 辞書形 + こと",
    "examples": [
      {
        "translation": "泳ぐことが大好きです。"
      },
      {
        "translation": "日本語を勉強することは楽しいです。"
      },
      {
        "translation": "友達と話すことがストレスを軽減します。"
      },
      {
        "translation": "彼は歌うことが得意です。"
      }
    ]
  },
  "ja_n5_Verb_57": {
    "title": "～ことができます (～koto ga dekimasu)",
    "shortExplanation": "能力や状況的な可能性を表し、「〜することができる」「〜することが可能である」という意味を表します。",
    "longExplanation": "「動詞 辞書形 ＋ ことができます」は、可能を表す最も基本的で丁寧な文型です。主に二つの意味合いで用いられます。①主体の能力や技術（「ピアノが弾ける」「外国語が話せる」など）。②状況・条件・規則などによる客観的な可能性（「ここで写真が撮れる」「予約ができる」など）。否定形は「～ことができません」となります。動詞を「こと」で名詞化した上で「ができます」を接続します。",
    "formation": "動詞 辞書形 + ことができます",
    "examples": [
      {
        "translation": "この問題を解くことができます。"
      },
      {
        "translation": "彼は英語を話すことができます。"
      },
      {
        "translation": "私は高い所に登ることができません。"
      },
      {
        "translation": "彼女はピアノを弾くことができます。"
      }
    ]
  },
  "ja_n5_Verb_58": {
    "title": "～ことができる (～koto ga dekiru)",
    "shortExplanation": "普通形（常体）で能力や客観的な可能性を表し、「〜できる」「〜することが可能だ」という意味を表します。",
    "longExplanation": "「動詞 辞書形 ＋ ことができる」は、「～ことができます」の普通形（簡体・常体）です。親しい間柄での日常会話や、論文・記事などの書き言葉で幅広く用いられます。また、「～ことができて、嬉しい」のように文の途中で接続したり、「～ことができる人」のように名詞修飾節を形成したりする際にも頻繁に活用されます。能力や客観的条件による可能性を示します。",
    "formation": "動詞 辞書形 + ことができる",
    "examples": [
      {
        "translation": "この問題を解くことができる？"
      },
      {
        "translation": "彼は泳ぐことができます。"
      },
      {
        "translation": "日本に行くことができて、とても嬉しいです。"
      },
      {
        "translation": "彼女はピアノを弾くことができます。"
      }
  ...
  "ja_n5_Verb_59": {
    "title": "～の (～no)",
    "shortExplanation": "親しい会話で理由や状況を柔らかく説明したり、動詞を名詞化したりする表現で、「〜のだ」「〜の（説明）」という意味を表します。",
    "longExplanation": "動詞の辞書形（普通形）に接続する「の」は、日常の親しい会話（タメ口）において主に二つの働きを持ちます。①文末に置いて、理由や事情、背景を相手に柔らかく説明・主張する表現（「のだ／のです」のくだけた口語表現）。特に女性や子どもが多用し、上昇調のイントネーションで疑問文にもなります。②文中で「走るのが好き」のように動詞を名詞化する準体助詞（形式名詞）として機能します。",
    "formation": "動詞 辞書形 + の（親しい口語）",
    "examples": [
      {
        "translation": "買い物をするために、銀行でお金をおろすの。"
      },
      {
        "translation": "友達にプレゼントをあげるので、ケーキを焼くの。"
      },
      {
        "translation": "ダイエットを始めるので、ジムに入会するの。"
      },
      {
        "translation": "軽い食事がいいので、サラダを作るの。"
      }
    ]
  },
  "ja_n5_Verb_60": {
    "title": "動詞辞書形 + 前に (ru mae ni)",
    "shortExplanation": "ある動作や出来事が起こる前に行動することを表し、「〜する前に」という意味です。",
    "longExplanation": "「～前に（まえに）」は、動詞の辞書形（基本形）に接続して、後続の動作や出来事が発生するよりも前に別の動作を行うことを表します。文末の主節が過去形であっても、「前に」の直前の動詞は常に現在形（辞書形）が用いられるのが重要な特徴です。",
    "formation": "動詞辞書形 + 前に",
    "examples": [
      {
        "translation": "出かける前に、部屋を掃除してください。"
      },
      {
        "translation": "寝る前に、歯を磨きます。"
      },
      {
        "translation": "雨が降る前に、洗濯物を取り込むこと。"
      },
      {
        "translation": "会議が始まる前に、資料を準備しましょう。"
      }
    ]
  },
  "ja_n5_あまりありません_61": {
  ...
  "ja_n4_A_0": {
    ...
    "shortExplanation": "代表的な例をいくつか並べて挙げる並立・例示の表現で、「〜や〜など」「〜とか〜など」という意味を表します。",
    "longExplanation": "「～とか～とか」は、同類のものの中からいくつか代表的な例を並べて挙げる不完全列挙の文法表現です。すべてを挙げ尽くすのではなく「他にもある」というニュアンスを含みます。日常会話で非常によく使われる口語的な表現で、名詞だけでなく動詞の普通形などにも接続できます。",
    "formation": "名詞 ＋ とか ＋ 名詞 ＋ とか（動詞普通形 ＋ とか）",
    "examples": [
      {
        "translation": "週末は映画とか買い物とか楽しいことをしたいです。"
      },
      {
        "translation": "彼女は英語とかフランス語とかいろいろな言葉を話せます。"
      },
      {
        "translation": "この店は寿司とか刺身とか日本料理を提供しています。"
      },
      {
        "translation": "1ドルBOXとか5ドルBOXとか、異なる価格のランチBOXがあります。"
      }
    ]
  },
  "ja_n4_A_1": {
    "title": "A は B ほど～ありません (A wa B hodo ～ arimasen)",
    "shortExplanation": "二つのものを比較して、AがBの程度に及ばないことを丁寧に表し、「AはBほど〜ではない／ありません」という意味を表します。",
    "longExplanation": "「A は B ほど～ありません」は、二つの事物や人を比較し、Aの度合いが基準となるBに達していないこと（劣等比較）を丁寧に表現する文型です。後続する述語には必ず丁寧な否定形（い形容詞「〜くありません」、な形容詞「〜ではありません」、動詞「〜ません」など）が呼応します。",
    "formation": "A は ＋ B ほど ＋ 形容詞・動詞の否定丁寧形（〜くありません／〜ではありません／〜ません）",
    "examples": [
      {
        "translation": "今日は昨日ほど寒くありません。"
      },
      {
        "translation": "彼は私ほど上手に英語を話せません。"
      },
      {
        "translation": "このレストランはあのレストランほど高くありません。"
      },
      {
        "translation": "彼女は彼ほど忙しくありません。"
      }
    ]
  },
  "ja_n4_A_2": {
    "title": "A は B ほど～ない (A wa B hodo ~ nai)",
    "shortExplanation": "二つのものを比較し、AがBの程度に達していないことを普通体で表し、「AはBほど〜ではない」という意味を表します。",
    "longExplanation": "「A は B ほど～ない」は、二者を比較してAが基準となるBの程度・水準に達していないこと（劣等比較）を普通体で述べる文型です。後ろには必ず否定表現が続き、い形容詞は「〜くない」、な形容詞は「〜じゃない／ではない」、動詞は否定形（可能動詞の否定形など）が接続します。",
    "formation": "A は ＋ B ほど ＋ い形容詞連用形（〜くない）／ な形容詞語幹 ＋ じゃない ／ 動詞否定形（可能否定など）",
    "examples": [
      {
        "translation": "山田さんは鈴木さんほど背が高くない。"
      },
      {
        "translation": "このリンゴはあのリンゴほど甘くない。"
      },
      {
        "translation": "彼は私ほど勉強ができない。"
      },
      {
        "translation": "このレストランはあのレストランほど静かじゃない。"
      }
    ]
  },
  "ja_n4_A_3": {
    "title": "A より B のほうが〜 (A yori B no hou ga 〜)",
    "shortExplanation": "二つのものを比較して、AよりもBのほうがその性質や程度が勝っていることを表し、「AよりBのほうが〜だ」という意味を表します。",
    "longExplanation": "「A より B のほうが〜」は、二つの事物や人物を比較し、比較の基準となるAに対して、Bのほうが性質・状態・程度において上回っていることを述べる比較構文です。「より」は比較の基準を示し、「のほうが」は取り立てて強調する対象（B）を示します。",
    "formation": "A ＋ より ＋ B ＋ のほうが ＋ 形容詞／動詞",
    "examples": [
      {
        "translation": "田中さんより鈴木さんのほうが背が高いです。"
      },
      {
        "translation": "リンゴよりバナナのほうが甘いです。"
      },
      {
        "translation": "冬より夏のほうが暑いです。"
      },
      {
        "translation": "東京より京都のほうが歴史があると思います。"
      }
    ]
  },
  "ja_n4_いAdjective_4": {
  ...
  "ja_n4_Noun_15": {
    ...
    "shortExplanation": "他人が話し手（または身内）に物を与えることを表し、「（私に）くれる／くれます」という意味を表します。",
    "longExplanation": "「～をくれる」は、他人が話し手または話し手の身内（家族など）に物を与える授受動詞の基本表現です。物の移動の方向が常に「他者から自分（身内）へ」向かう点に特徴があります。相手が目上の人の場合は「くださる」を用います。日常会話では丁寧形の「くれます」「くれました」が多く使われます。",
    "formation": "相手（授与者） ＋ が ＋ 話し手側 ＋ に ＋ 名詞（物） ＋ を ＋ くれる（丁寧形：くれます／くれました）",
    "examples": [
      {
        "translation": "友達が私にプレゼントをくれました。"
      },
      {
        "translation": "彼が私に花をくれた。"
      },
      {
        "translation": "先生が私に本をくれました。"
      },
      {
        "translation": "お母さんが弟にお菓子をくれました。"
      }
    ]
  },
  "ja_n4_Noun_16": {
    "title": "～をさしあげる (〜wo sashiageru)",
    "shortExplanation": "「あげる」の謙譲語で、目上の人や客などに物を差し出すことをへりくだって表し、「（〜に）差し上げる／差し上げます」という意味を表します。",
    "longExplanation": "「～をさしあげる」は、授受動詞「あげる」の謙譲語表現です。話し手が先生や上司、あるいは顧客などの目上の人に対して物を進呈・提供する際に、自身の行為をへりくだることで相手に敬意を表します。ビジネスや改まった場面で頻繁に使われ、日常会話では丁寧形の「さしあげます」が多く用いられます。",
    "formation": "相手（目上の人・客など） ＋ に ＋ 名詞（物） ＋ を ＋ さしあげる（丁寧形：さしあげます）",
    "examples": [
      {
        "translation": "先生に本をさしあげます。"
      },
      {
        "translation": "お母さんに花をさしあげたいです。"
      },
      {
        "translation": "お客様にお茶をさしあげましょう。"
      },
      {
        "translation": "先輩にプレゼントをさしあげたら、喜んでいました。"
      }
    ]
  },
  "ja_n4_Noun_17": {
    "title": "～をもらう (〜wo morau)",
    "shortExplanation": "他者から物を受け取ることを表し、「〜から／に（物を）もらう／もらいます」という意味を表します。",
    "longExplanation": "「～をもらう」は、話し手（または身内）が受益者（受け取る側）の視点に立って、他者から品物や贈り物、アドバイスなどを受け取ることを表す授受動詞です。贈り主（授与者）の後ろには助詞「に」または「から」を置きます。目上の人から受け取る場合は謙譲語の「いただく」を用います。丁寧な場面では「もらいます」「もらいました」の形をとります。",
    "formation": "相手（授与者） ＋ に／から ＋ 名詞（物） ＋ を ＋ もらう（丁寧形：もらいます／もらいました）",
    "examples": [
      {
        "translation": "友達からプレゼントをもらいました。"
      },
      ...
      {
        "translation": "お父さんからお小遣いをもらう。"
      },
      {
        "translation": "彼女に手紙をもらった。"
      }
    ]
  },
  "ja_n4_Noun_18": {
    "title": "～中 (〜chuu / 〜jyuu)",
    "shortExplanation": "動作や出来事が現在進行中であることや、ある期間・範囲の全体を表し、「〜している最中」「〜の間中」という意味を表します。",
    "longExplanation": "接尾辞「～中」は名詞に直接接続し、主に二つの意味を表します。①その動作や状態が現在まさに行われている最中であること（主に「ちゅう」と読み、「仕事中」「勉強中」「準備中」など）。②ある期間の全体、または場所・範囲の全体にわたることを表す用法（主に「じゅう」と読み、「今日中」「一日中」「世界中」など）。案内表示や日常会話で幅広く用いられます。",
    "formation": "名詞 ＋ 中（読み：ちゅう／じゅう）",
    "examples": [
      {
        "translation": "彼は仕事中です。"
      },
      {
        "translation": "試験中、携帯電話を使ってはいけません。"
      },
      {
        "translation": "映画を観ている最中に、彼は泣き始めました。"
      },
      {
        "translation": "彼女は今勉強中です。"
      }
    ]
  },
  "ja_n4_Verb_19": {
  ...
  "ja_n4_Verb_35": {
    ...
    "shortExplanation": "ある継続的な動作や状態が続いている時間帯の中で、別の動作や出来事がある時点で行われることを表し、「〜している間に」という意味を表します。",
    "longExplanation": "「～ている間に」は、前項の動作や状態が継続している時間的な幅（期間）の中で、後項の瞬間的・一時的な動作や出来事が発生・完了することを表す文型です。前項の期間全体にわたって後項の動作が継続する「～ている間」とは異なり、助詞「に」があることで、その期間内の「ある一時点」に後項が生起したことが示されます。",
    "formation": "動詞て形 ＋ いる ＋ 間に",
    "examples": [
      {
        "translation": "映画を見ている間に、彼は寝てしまった。"
      },
      {
        "translation": "子供が遊んでいる間に、私は料理を作ります。"
      },
      {
        "translation": "会議が行われている間に、雨が降り始めた。"
      },
      {
        "translation": "彼が仕事をしている間に、私たちは買い物に行く。"
      }
    ]
  },
  "ja_n4_Verb_36": {
    "title": "～ておく (～te oku)",
    "shortExplanation": "将来の目的や次の事態に備えてあらかじめ準備として動作を行うことを表し、「〜しておく」という意味を表します。",
    "longExplanation": "「～ておく」は、動詞のて形に補助動詞「おく」が接続した構文で、主に以下の意味を表します。①将来の目的や予定された事態のために、事前に準備として動作を行うこと（事前準備）。②その後の利用のために必要な処置を済ませておくこと（事後処理）。③その状態のまま放置しておくこと。日常会話では「～とく」（例：買っておく→買っとく、しておきます→しときます）と縮約された口語形が頻繁に用いられます。",
    "formation": "動詞て形 ＋ おく（口語短縮形：～とく）",
    "examples": [
      {
        "translation": "駅で切符を買っておこう。"
      },
      {
        "translation": "明日早く起きるために、今晩早く寝ておきます。"
      },
      {
        "translation": "試験前に勉強しておかないと、失敗するかもしれない。"
      },
      {
        "translation": "彼が到着する前に、部屋をきれいに掃除しておきましょう。"
      }
    ]
  },
  "ja_n4_Verb_37": {
  ...
  "ja_n3_A_0": {
    ...
    "shortExplanation": "前述の事柄にさらに同方向の情報を付け加える表現で、「それに加えて」「さらに」「おまけに」という意味を表します。",
    "longExplanation": "「A その上 B」は、文や節Aで述べた内容に対して、さらに同じ性質（良いことには良いこと、悪いことには悪いこと）の情報Bを付け足して強調する接続表現です。単に並列するだけでなく、事態がさらに重なるニュアンスを持ち、書き言葉から改まった口語まで広く用いられます。",
    "formation": "節/文A ＋ その上（そのうえ） ＋ 節/文B",
    "examples": [
      {
        "translation": "彼は頭が良い。その上、スポーツも得意だ。"
      },
      {
        "translation": "このカフェは雰囲気がいい。その上、料理も美味しい。"
      },
      {
        "translation": "このアパートは駅に近い。その上、家賃も安い。"
      },
      {
        "translation": "彼女は仕事ができる。その上、誰とでも仲良くなれる。"
      }
    ]
  },
  "ja_n3_うちに_1": {
  ...
  "ja_n2_A_0": {
    ...
    "shortExplanation": "同等の選択肢を並列して提示する改まった接続詞で、「または」「もしくは」「あるいは」という意味を表します。",
    "longExplanation": "接続詞「あるいは」（漢字表記：或いは）は、同等の資格を持つ二つ以上の語句や文を並列し、いずれかを選択可能であることを示す表現です。文語的・改まった響きを持つため、ビジネス文書、公的通知、学術論文、法令文、ニュース報道などの公的な場面で広く用いられます。日常会話での「または」「それとも」に相当するフォーマルな語です。",
    "formation": "句A／文A ＋ あるいは ＋ 句B／文B",
    "examples": [
      {
        "translation": "今日は映画を見るあるいはショッピングをする予定です。"
      },
      {
        "translation": "彼女は英語あるいはドイツ語で話すことができます。"
      },
      {
        "translation": "僕らはコーヒーあるいは紅茶を飲むのが好きです。"
      },
      {
        "translation": "この仕事は正社員あるいは契約社員として働くことができます。"
      }
    ]
  },
  "ja_n2_Aおまけに_1": {
  ...
  "ja_n2_A_5": {
    ...
    "shortExplanation": "前の言葉や文を言い換えたり、同等・本質的な意味を要約して説明する改まった接続詞で、「つまり」「言い換えれば」「すなわち」という意味を表します。",
    "longExplanation": "接続詞「すなわち」（漢字表記：即ち）は、先行する語句や文Aの内容を、別の表現で言い換えたり、その本質・定義を明確に提示したりする（AとBが等価であることを示す）際に用いられます。「つまり」「要するに」よりも改まった文章語であり、学術的な定義付け、論理的な解説、結論の要約などで多用されます。",
    "formation": "句A／文A ＋ すなわち ＋ 句B／文B",
    "examples": [
      {
        "translation": "私は立派な成果を出したい、すなわち、成功したいのです。"
      },
      {
        "translation": "彼は言葉に詰まった、すなわち、何も言えなかった。"
      },
      {
        "translation": "彼女は自分の目標に向かって努力し続けている、すなわち、彼女は非常に頑張っている。"
      },
      {
        "translation": "この店はお客様の満足を一番大事にしています、すなわち、サービスが良いということです。"
      }
    ]
  },
  "ja_n2_Aすると_6": {
  ...
  "ja_n2_Noun_25": {
    "title": "名詞 ＋ につき (〜ni tsuki)",
    "shortExplanation": "掲示や公的文書などで改まった理由・原因を表す用法（「〜のため」「〜につき」）と、数量・単位ごとの割合を表す用法（「〜あたり」「〜ごとに」）を持ちます。",
    "longExplanation": "「～につき」には大きく分けて二つの用法があります。①【理由・原因】看板、張り紙、告知文などの改まった書き言葉において、客観的な事由を簡潔に提示する際に用いられます（例：工事中につき立入禁止、改装中につき休業）。②【割合・基準】数量詞や単位名詞の後ろに付き、「〜あたり」「〜ごとに」という分配・対応の基準を示します。",
    "formation": "名詞 ＋ につき",
    "examples": [
      {
        "translation": "試験につき、今日は静かにしてください。"
      },
      {
        "translation": "このエリアは工事中につき、通行止めです。"
      },
      {
        "translation": "博物館は整備中につき、入場料が無料です。"
      },
      {
        "translation": "商品お一つにつき、1000円の割引があります。"
      }
    ]
  },
  "ja_n2_Noun_26": {
    "title": "名詞 ＋ にて (Noun nite)",
    "shortExplanation": "格助詞「で」に相当する改まった格調高い文語的表現で、動作・催しが行われる場所（「〜で」「〜において」）や手段・方法（「〜によって」）を表します。",
    "longExplanation": "格助詞「にて」は、現代語の「で」と同様に場所、手段、方法、材料などを表しますが、非常に改まったフォーマルな語感を持ちます。公的な案内通知、招待状、ビジネスメール、報道発表などの文章語において、催し物や会議が開催される場所を明示したり（例：会場にて）、伝達・調査の手段を示したり（例：書面にて、メールにて）する際によく用いられます。",
    "formation": "名詞（場所・手段・方法） ＋ にて",
    "examples": [
      {
        "translation": "駅前広場にてイベントが開催されます。"
      },
      {
        "translation": "ホテルにて会議が行われます。"
      },
      {
        "translation": "郵便局にて荷物を受け取りました。"
      },
      {
        "translation": "インターネットにて調べたら、答えが見つかりました。"
      }
    ]
  },
  "ja_n2_Noun_27": {
    "title": "名詞 ＋ のことだから (Noun no koto dakara)",
    "shortExplanation": "その人の性格や普段の行動パターン、あるいはそのものの固有の性質を根拠にして、「あの人ならきっと〜だろう」と強く推測する表現です。「〜のことだから」「〜の性格から考えて」。",
    "longExplanation": "「～のことだから」は、話し手がよく知っている人物（場合によっては組織や事物）の名詞に付き、その人物の普段の性格、信条、習慣などを拠り所として、「あの人であれば当然このように振る舞うに違いない」と確信を持って推測・判断する際に用います。文末には「〜だろう」「〜に違いない」「〜はずだ」「〜かもしれない」といった推量の表現が伴います。",
    "formation": "名詞（人物・組織・事物） ＋ のことだから",
    "examples": [
      {
        "translation": "料理が得意な彼のことだから、美味しい料理を作ってくれるでしょう。"
      },
      {
        "translation": "いつも遅刻する彼女のことだから、今日も遅れるかもしれない。"
      },
      {
        "translation": "安い店のことだから、たくさん売れるはずだ。"
      },
      {
        "translation": "ドラマ好きな彼のことだから、最新のドラマについて話すといいでしょう。"
      }
    ]
  },
  "ja_n2_Noun_28": {
    "title": "名詞 ＋ をはじめ (Noun wo hajime)",
    "shortExplanation": "同類の事柄の中から最も代表的なものを第一に挙げ、それに限らず他にも多く存在することを示す表現です。「〜をはじめ」「〜を代表として」。",
    "longExplanation": "文法項目「～をはじめ」は、動詞「始める」に由来し、ある集団やグループの中で最も知名度が高く典型的なものを代表例としてまず1つ提示し、他にも同様の事柄が多くあることを表します。スピーチ、報道、公的な文章などの改まった場面で頻繁に用いられます。",
    "formation": "名詞 ＋ をはじめ",
    "examples": [
      {
        "translation": "日本料理をはじめ、さまざまな料理がこのレストランで楽しめます。"
      },
      {
        "translation": "彼は絵画をはじめ、彫刻や写真もコレクションしている。"
      },
      {
        "translation": "京都をはじめ、日本のいくつかの都市で伝統的な祭りが行われている。"
      },
      {
        "translation": "太陽をはじめ、地球や火星などの惑星も太陽系に含まれている。"
      }
    ]
  },
  "ja_n2_Noun_29": {
    "title": "名詞 ＋ をはじめとして (Noun wo hajime to shite)",
    "shortExplanation": "集団の中で最も際立った代表例を提示し、それを含めた全体を包括的に述べる表現です。「〜をはじめとして」「〜を筆頭に」。",
    "longExplanation": "「～をはじめとして」は「～をはじめ」の強調的・副詞的な形式であり、より硬く改まった語感を持ちます。ある分野や集団において一番の典型例・代表例を筆頭に掲げ、それと同類あるいは関連するものが広く存在することを印象づけます。公式発表や公的文書、解説文などで好まれます。",
    "formation": "名詞 ＋ をはじめとして",
    "examples": [
      {
        "translation": "東京をはじめとして、日本にはたくさんの観光スポットがあります。"
      },
      {
        "translation": "彼は、ピアノをはじめとして、たくさんの楽器を演奏できます。"
      },
      {
        "translation": "この本は手作りのガーゼマスクをはじめとして、便利な生活アイディアが満載です。"
      },
      {
        "translation": "そのショッピングモールには、ZARAをはじめとして、多くのブランドが集まっています。"
      }
    ]
  },
  "ja_n2_Noun_30": {
    "title": "名詞1 ＋ をはじめとする ＋ 名詞2 (Noun o hajime to suru Noun)",
    "shortExplanation": "名詞1を代表的な一例として挙げ、後ろの名詞2（全体グループ）を直接修飾する連体修飾表現です。「名詞1をはじめとする名詞2」。",
    "longExplanation": "連体修飾の形「名詞1 ＋ をはじめとする ＋ 名詞2」は、後続する名詞2を修飾します。名詞1には最も典型的・代表的な個別具体例が入り、名詞2にはそのカテゴリー全体を総称する包括的な名詞（人気アーティスト、外国語、書籍など）が来ます。「名詞1を筆頭とするような名詞2の数々」という意味を表します。",
    "formation": "名詞1 ＋ をはじめとする ＋ 名詞2",
    "examples": [
      {
        "translation": "彼はフランス語をはじめとする外国語が話せる。"
      },
      {
        "translation": "このコンサートには、BTSをはじめとする人気アーティストが出演する予定です。"
      },
      {
        "translation": "彼女は魚をはじめとする海の幸が大好きだ。"
      },
      {
        "translation": "この図書館には、子供向けの本をはじめとするさまざまなジャンルの本があります。"
      }
    ]
  },
  "ja_n2_Noun_31": {
    "title": "名詞 ＋ をめぐって (Noun wo megutte)",
    "shortExplanation": "ある問題や対立点を中心にして、複数の人々や勢力が議論、対立、争いなどを繰り広げることを表します。「〜をめぐって」「〜に関して」。",
    "longExplanation": "「～をめぐって」は動詞「巡る」から派生した表現で、ある争点、事件、関心事などが中心にあり、その周囲にいる複数の関係者・当事者の間で意見の対立、議論、奪い合い、交渉などが展開される状況を表します。後続する述語には「議論する」「争う」「対立する」「話し合う」など、複数の主体が関与する動詞が用いられます。",
    "formation": "名詞 ＋ をめぐって",
    "examples": [
      {
        "translation": "環境問題をめぐって、多くの議論が行われています。"
      },
      {
        "translation": "彼の死をめぐって、いくつかの陰謀説が浮かび上がっている。"
      },
      {
        "translation": "昇給をめぐって会社と労働組合が話し合いをしています。"
      },
      {
        "translation": "この映画をめぐって、賛否両論が存在している。"
      }
    ]
  },
  "ja_n2_Noun_32": {
    "title": "名詞1 ＋ をめぐる ＋ 名詞2 (Noun o meguru Noun)",
    "shortExplanation": "名詞1を中心課題や発端として生じる議論、騒動、会議などの名詞2を直接修飾する表現です。「名詞1をめぐる名詞2」。",
    "longExplanation": "連体修飾表現「～をめぐる ＋ 名詞」は、後続する名詞（議論、対立、噂、国際会議など）を直接修飾します。前項の名詞1が中心的な焦点・発端となって、後項の出来事や活動が巻き起こっていることを表します。ニュース報道や社会評論などの客観的・公式な文脈で頻出します。",
    "formation": "名詞1 ＋ をめぐる ＋ 名詞2",
    "examples": [
      {
        "translation": "この事件をめぐる議論が続いています。"
      },
      {
        "translation": "環境問題をめぐる国際会議が開かれます。"
      },
      {
        "translation": "彼の突然の辞任をめぐるうわさが広がっている。"
      },
      {
        "translation": "映画祭をめぐる活動が多くなっています。"
      }
    ]
  },
  "ja_n2_Noun_33": {
    "title": "名詞 ＋ をもとに (Noun o moto ni)",
    "shortExplanation": "ある事実、データ、経験、原案などを基礎的な素材や手がかりとして、新たなものを創作・判断することを表します。「〜をもとに」「〜に基づいて」。",
    "longExplanation": "文法表現「～をもとに」（漢字では「基に」）は、ある事実、実際の出来事、経験、収集したデータ、アイデアなどを土台・出発点とし、そこから新しい作品を作ったり、判断・分析・企画を行ったりする際に用いられます。物理的な原材料を表す「～を原料に」とは異なり、無形の情報、データ、モチーフ、参考事例などに広く使われます。",
    "formation": "名詞 ＋ をもとに",
    "examples": [
      {
        "translation": "この映画は実話をもとに作られました。"
      },
      {
        "translation": "彼の経験をもとにアドバイスが必要だ。"
      },
      {
        "translation": "データをもとに分析を行いました。"
      },
      {
        "translation": "世界中の美術館をもとにコレクションを作りました。"
      }
    ]
  },
  "ja_n2_Noun_34": {
    "title": "名詞 ＋ をもとにして (Noun wo moto ni shite)",
    "shortExplanation": "ある資料や先例などを基礎・根拠として具体的な作業や計画を進めることを表します。「〜をもとにして」「〜を基礎として」。",
    "longExplanation": "「～をもとにして」は「～をもとに」に接続助詞「て」が付いた形であり、ある特定のデータ、意見、資料、過去の成功例などを素材・手がかりとして活用し、計画の変更、執筆、レポート作成などの行為を積極的に進めることを表します。作業や創作の根拠・手法としてのニュアンスが明確に表現されます。",
    "formation": "名詞 ＋ をもとにして",
    "examples": [
      {
        "translation": "彼の意見をもとにして、計画を変更しました。"
      },
      {
        "translation": "この小説は実話をもとにして書かれています。"
      },
      {
        "translation": "資料をもとにして、レポートを作成しました。"
      },
      {
        "translation": "過去の成功例をもとにして、新しいプロジェクトを進める予定です。"
      }
    ]
  },
  "ja_n2_Verb_35": {
