# LinguaTube — AI Agent Instructions & Architectural Guide (AGENTS.md)
...
```
lingua-tube/
├── AGENTS.md                  # This file (AI agent guidance & architecture)
...
│   │   ├── translate/         # Translation endpoint & batch translation
│   │   └── auth-config.js     # Auth settings endpoint
...
│   │   ├── data/              # Grammar databases (JA, KO, ZH, EN) & fallback dictionaries
│   │   ├── features/          # Feature domains:
│   │   │   ├── video/         # VideoPlayer, SubtitleDisplay, SubtitleUpload, TranscriptService
│   │   │   ├── dictionary/    # DictionaryPanel, WordPopup, GrammarPopup, DictionaryService
│   │   │   ├── vocabulary/    # VocabularyList, VocabularyQuickView, StudyPage (SRS)
│   │   │   ├── playlist/      # PlaylistPage, PlaylistPanel, AddToPlaylistDialog
│   │   │   ├── history/       # HistoryPage, HistoryList, HistoryService
│   │   │   └── quiz/          # QuizInput interactive exercise component
...
│   │   └── strategies/        # Custom route reuse strategy
